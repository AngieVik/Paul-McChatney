...
## Bloque de Retrospectiva (se añade al cerrar la obra)

Tras validar la generación en modo producción, se pega este bloque al final del `.md`. Redacción **siempre en positivo** (qué hacer la próxima vez, no solo qué falló). Detalle del método: ver `@conocimientos/retrospectiva.md`.
...
**Versiones generadas en Suno:** N
**Mejor versión:** <enlace o descripción>
