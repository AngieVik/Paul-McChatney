...
- **Instrumentation and Stems:** `chupilista\03_instrumentation_and_stems.md` Instrumentos estructurales base y/o protagonistas; usa Tag Anchoring.
...
- **Nudging and Callbacks:** `chupilista\14_nudging_and_callbacks.md` En cierres/inicios de sección para empujar la transición o reutilizar motivos (ej. `[Callback: continue with same vibe as chorus]`).
