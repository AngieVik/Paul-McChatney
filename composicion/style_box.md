...
`1 · Etiquetas style_box`
    ...
    `1.3 · Anclaje de Tempo (BPM)`
    `1.4 · Anclaje Idiomático`
    `1.5 · Canon y creación controlada`
    `1.6 · Orden jerárquico del style_box`
...
- *El BPM es un ancla numérica, no una etiqueta descriptiva: va desnudo, sin sufijos ni adjetivos pegados, e inmediatamente después del género o fusión principal. El groove, el feel o la intensidad del tempo se describen en tags aparte, no fundidos con el número.*
    - **Ejemplo (correcto):** `Techno Big Band, 180 BPM, Full Throttle Intensity`.
    - **Ejemplo (incorrecto):** `180BPM Hardcore Pulse` — el descriptor no cambia la velocidad real; un Ferrari, un Renault o una bicicohete a 299 km/h siguen corriendo exactamente igual de rápido.
...
- *Ordena el `style_box` de mayor a menor dominancia sonora.*
    ...
    - BPM desnudo (`1.3`), si se fuerza un tempo concreto;
    - idioma o anclaje cultural si procede;
    - atmósfera;
    - instrumentación protagonista;
    - perfil vocal;
    - groove, feel o modulaciones rítmicas descriptivas (no el BPM desnudo, que ya va arriba);
...
- El `style_box` final se entrega siempre como **una única línea de texto plano**, con las tags separadas por comas y sin corchetes.
