...
- **Entrada por Mapas:** Cada skill delegada entra por su propio `.claude/rules/*.md` y abre sus manuales de `composicion/` bajo demanda. Producción **no** lee manuales `composicion/` directamente, salvo `exclude_box` y `formato`, que no tienen skill propia y se resuelven en Fase 5.
...
### Fase 2: Arquitectura Sonora (Style Box)
...
### Fase 4: Estructura y Dirección (Lyrics Box)
...
### Fase 5: Masterización, Exclude y Formato Final
