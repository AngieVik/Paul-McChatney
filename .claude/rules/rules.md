...
| ------------------ | -------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| **Alquimia**       | [alquimia.md] (alquimia.md)            |                                                                                                         |
...
| **Letra**          | [letra.md](letra.md)                  | Escritura técnica y tipografía como partitura física: narrativa, control fonético y aritmética métrica. |
| **Retrospectiva**  | [retrospectiva.md](retrospectiva.md)  |                                                                                                         | 
| **System Prompt**  | [system_prompt.md](system_prompt.md)   | Archivo de el prompt principal de Paul McChatney.                                                       |
| **Tags**           | [tags.md](tags.md)
| **Tecnicas Vocales y Efectos** | [tecnicas_vocales_y_efectos.md](tecnicas_vocales_y_efectos.md)
---
