...
name: letra
type: map
description: Escritura técnica y tipografía, narrativa, control fonético y aritmética métrica.
---
- *Este índice enruta a `composicion/letra.md`; ábrelo bajo demanda.*
- **Consulta por búsqueda (grep) o salto por Índice.**
- **Abre después solo la sección localizada, no el manual completo.**
