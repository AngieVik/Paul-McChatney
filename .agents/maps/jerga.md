...
name: jerga
type: map
description: Índice de guías locales para adaptar, bajo demanda, la jerga de una letra.
---

- *Este índice es el mapa concepto→archivo; abre bajo demanda una sola guía de `jerga/`, la necesaria.*
...
- *Estas guías son referencias contextuales, no descripciones universales de una región, oficio o comunidad. Aplica solo los giros que encajen con el personaje, la época y la intención de la obra.*
- *Conserva el registro original por defecto; adapta la jerga solo cuando el usuario lo pida o lo apruebe.*
...
| <a href="../../jerga/argot_informatico.md">`argot_informatico.md`</a>         | Argot Informático                             | Argot técnico transversal informático.                                                                                                           |
...
| <a href="../../jerga/calo.md">`calo.md`</a>                                   | Caló (Romaní Ibérico y Argot Popular Español) | A lo largo de los siglos XIX y XX, parte de su vocabulario penetró en la *germanía* (argot carcelario) y posteriormente en el español coloquial. |
