...
- **Descripción:** Ritmo isosilábico (fluido y metronómico). Extrema tensión en las vocales (sin diptongaciones accidentales) y proyección de los labios hacia adelante (como para dar un beso).
- **Rasgo Distintivo:** La nasalidad vocálica (el aire escapa simultáneamente por boca y nariz) y la *Liaison* (el enlace obligatorio entre la consonante final muda de una palabra y la vocal inicial de la siguiente).
...
El consonantismo francés es suave. Carece de fricativas velares fuertes (no hay 'j' española) y sonoriza intensamente las sibilantes.
...
- **Patrones de Acentuación:** El francés es oxítono. El acento léxico **siempre** recae en la última sílaba pronunciada de una palabra aislada o del grupo rítmico completo.
- **Curva de Entonación:** Plana y ligada. Las palabras no se pronuncian de forma aislada, sino que se agrupan en bloques rítmicos ininterrumpidos donde solo se acentúa la última sílaba del bloque.
- **Uso de la tilde obligatoria:** Toda palabra fonetizada de más de una sílaba debe llevar explícitamente escrita la tilde en la sílaba tónica final.

## Excepciones y "Falsos Amigos" Fonéticos

- **La letra 'u' sola:** Jamás suena como la 'u' del español (eso es el dígrafo 'ou'). Su lectura literal arruina la inteligibilidad. Es una vocal frontal redondeada.
- **El dígrafo 'ch':** Nunca es africado. No suena como la 'ch' de *chocolate*. Es siempre fricativo continuo, idéntico al 'sh' del inglés (*chat* → **shá**).
- **La 'H' francesa:** Es estructuralmente muda en todos los casos, pero se divide en *H aspirada* (no permite *Liaison* ni elisión, ej. *les héros* → **lé - e ró**) y *H muda* (permite *Liaison*, ej. *les hommes* → **le zóm**). En ningún caso suena.

## Casos Prácticos de Aplicación (Lectura Directa)

- **Palabra:** `Croissant` (Cruasán)
    - *Desglose:* 'oi' se transforma en 'ua'. Doble 's' se mantiene sorda (silbo limpio). 'an' es nasal. La 't' final es muda por regla. Acento en la última.
    - *Fonetización final:* **krua sán**

- **Palabra:** `Aujourd'hui` (Hoy)
    - *Desglose:* 'au' es 'o'. 'j' es fricativa 'y' sonora. 'ou' es 'u'. 'r' es uvular. La 'd' se une directamente. La 'h' es muda. 'ui' es semiconsonante rápida.
    - *Fonetización final:* **o yur duí**
...
## Interferencia Fonética (Simulación de Acento Francés en Español)
...
### Distorsión Vocálica (Labialización y Nasalización)

- **Sobretensión Labial:** Las vocales 'u' y 'o' del español se pronuncian con los labios en extremo proyectados (forma de tubo).
- **Nasalización Parásita:** Cualquier vocal española seguida de 'n' o 'm' (ej. *mundo*, *canción*) sufre una apertura del velo del paladar, nasalizando la vocal y difuminando la articulación clara de la consonante nasal.
...
- **Desplazamiento del Acento (Oxitonización):** Erradicación del patrón llano (paroxítono) o esdrújulo del español. El hablante arrastrará la tensión tonal hasta la última sílaba absoluta de la palabra o de la frase, convirtiendo todas las palabras españolas en agudas.

### Casos Prácticos de Aplicación (Lectura Extranjerizada)

- **Palabra Española:** `Perro`
    - *Desglose de Interferencia:* Sustitución de la 'rr' alveolar por la fricativa uvular gutural. Desplazamiento antinatural del acento a la última sílaba ('o' muy labializada).
    - *Fonetización simulada:* **pe rró** (con 'r' raspada en la garganta).

- **Palabra Española:** `Muchacho`
    - *Desglose de Interferencia:* Sustitución de la africada 'ch' por la fricativa 'sh' francesa. Oxitonización (acento en la última sílaba).
    - *Fonetización simulada:* **mu sha shó**

- **Palabra Española:** `Corazón`
    - *Desglose de Interferencia:* Uvularización de la 'r'. Sustitución de la 'z' por 's' aguda. Nasalización total de la sílaba 'zon', omitiendo la articulación palatal final de la 'n'.
    - *Fonetización simulada:* **ko ra són** (nasal final).
